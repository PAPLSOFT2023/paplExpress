...
@Component({
  selector: 'app-rejected-report-dash',
  templateUrl: './rejected-report-dash.component.html',
  styleUrls: ['./rejected-report-dash.component.scss']
})
export class RejectedReportDashComponent {
